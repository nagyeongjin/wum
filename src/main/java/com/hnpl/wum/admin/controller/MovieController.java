...
public class MovieController {
    ...
    public String movieDtl(@PathVariable("movieSeq") Long movieSeq,
                           Principal principal,
                           @ModelAttribute("scoreDto") ScoreDto scoreDto,
                           Model model) {
        String heartImg;
        ...
        System.out.println("reviewResult(movieController) : " + reviewResult);
    ...
    @ResponseBody
    public Map<String, Object> insertWish(@RequestBody Map<String, Long> request,
                                          Principal principal) {
        ...
        Long userSeq = userService.findUserSeq(principal.getName());
        System.out.printf("userSeq(MovieController : " + userSeq);
    ...
    public String recommendUp (@RequestParam("scoreSeq") Long scoreSeq,
                                @RequestParam("movieSeq")Long movieSeq,
                               Principal principal){

        Long userSeq = userService.findUserSeq(principal.getName());

        movieService.recommend(scoreSeq, userSeq);

        return "redirect:/movie/"+movieSeq;
